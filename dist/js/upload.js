(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('mytagsupload', ['utilities'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.mytagsUpload = factory(global.mytags.util));
    ...
    var Component = {
        ...
        data: {
            ...
            type: '',
            url: '',
            abort: utilities.noop,
            beforeAll: utilities.noop,
            beforeSend: utilities.noop,
            complete: utilities.noop,
            completeAll: utilities.noop,
            error: utilities.noop,
            fail: utilities.noop,
            load: utilities.noop,
            loadEnd: utilities.noop,
            loadStart: utilities.noop,
            progress: utilities.noop
        },
        ...
        events: {
            ...
            change: function(e) {
                ...
                if (!utilities.matches(e.target, 'input[type="file"]')) {
                    return;
                }
            ...
            drop: function(e) {
                ...
                utilities.removeClass(this.$el, this.clsDragover);
            ...
            dragover: function(e) {
                stop(e);
                utilities.addClass(this.$el, this.clsDragover);
            },
        ...
        methods: {
            ...
            upload: function(files) {
                ...
                utilities.trigger(this.$el, 'upload', [files]);
    ...
    if (typeof window !== 'undefined' && window.mytags) {
        window.mytags.component('upload', Component);
    }
