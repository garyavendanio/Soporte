(function (global, factory) {
    ...
    var parseCssVar = memoize(function (name) {
        /* usage in css: .x-name:before { content:"xyz" } */

        var element = append(document.documentElement, document.createElement('div'));

        addClass(element, ("x-" + name));
    ...
    function getCssVar(name) {
        return !isIE
            ? getStyles(document.documentElement).getPropertyValue(("--x-" + name))
            : parseCssVar(name);
    }
    ...
    function transition(element, props, duration, timing) {
        ...
        return Promise$1.all(toNodes(element).map(function (element) { return new Promise$1(function (resolve, reject) {
                ...
                once(element, 'transitionend transitioncanceled', function (ref) {
                    ...
                    clearTimeout(timer);
                    removeClass(element, 'x-transition');
                    css(element, {
                        transitionProperty: '',
                        transitionDuration: '',
    ...
    var Transition = {
        ...
        inProgress: function(element) {
            return hasClass(element, 'x-transition');
        }

    };

    var animationPrefix = 'x-animation-';
    ...
    function animate$1(element, animation, duration, origin, out) {
        ...
        return Promise$1.all(toNodes(element).map(function (element) { return new Promise$1(function (resolve, reject) {
                ...
                if (startsWith(animation, animationPrefix)) {
                    origin && addClass(element, ("x-transform-origin-" + origin));
    ...
    */
    ...
    function Core (mytags) {
        ...
        on(document, 'animationstart', function (ref) {
            ...
            if ((css(target, 'animationName') || '').match(/^x-.*(left|right)/)) {
    ...
    var Accordion = {
        ...
        data: {
            ...
            multiple: false,
            clsOpen: 'x-open',
            toggle: '> .x-accordion-title',
            content: '> .x-accordion-content',
            transition: 'ease',
            offset: 0
        },
    ...
    var drop = {
        ...
        computed: {
            ...
            clsDrop: function(ref) {
                ...
                return clsDrop || ("x-" + (this.$options.name));
            },
    ...
    var Margin = {
        ...
        data: {
            margin: 'x-margin-small-top',
            firstColumn: 'x-first-column'
        },
    ...
    var grid = {
        ...
        data: {
            margin: 'x-grid-margin',
            clsStack: 'x-grid-stack',
            masonry: false,
            parallax: 0
        },

        connected: function() {
            this.masonry && addClass(this.$el, 'x-flex-top x-flex-wrap-top');
        },
    ...
    function applyAnimation(el) {
        ...
        if (length) {
            el.style.setProperty('--x-animation-stroke', length);
        }
    ...
    var Slidenav = {
        ...
        computed: {
            ...
            icon: function(ref, $el) {
                ...
                return hasClass($el, 'x-slidenav-large')
                    ? (icon + "-large")
                    : icon;
            }
    ...
    var Search = {
        ...
        computed: {
            ...
            icon: function(ref, $el) {
                ...
                return hasClass($el, 'x-search-icon') && parents($el, '.x-search-large').length
                    ? 'search-large'
                    : parents($el, '.x-search-navbar').length
                        ? 'search-navbar'
                        : icon;
            }
    ...
    var Close = {
        ...
        computed: {
            ...
            icon: function() {
                return ("close-" + (hasClass(this.$el, 'x-close-large') ? 'large' : 'icon'));
            }
    ...
    function install$2(ref) {
        ...
        modal.dialog = function (content, options) {
            ...
            var dialog = modal(
                ("<div class=\"x-modal\"> <div class=\"x-modal-dialog\">" + content + "</div> </div>"),
                options
            );
        ...
        modal.alert = function (message, options) {
            return openDialog(
                function (ref) {
                    ...
                    return ("<div class=\"x-modal-body\">" + (isString(message) ? message : html(message)) + "</div> <div class=\"x-modal-footer x-text-right\"> <button class=\"x-button x-button-primary x-modal-close\" autofocus>" + (labels.ok) + "</button> </div>");
            },
                options,
        ...
        modal.confirm = function (message, options) {
            return openDialog(
                function (ref) {
                    ...
                    return ("<form> <div class=\"x-modal-body\">" + (isString(message) ? message : html(message)) + "</div> <div class=\"x-modal-footer x-text-right\"> <button class=\"x-button x-button-default x-modal-close\" type=\"button\">" + (labels.cancel) + "</button> <button class=\"x-button x-button-primary\" autofocus>" + (labels.ok) + "</button> </div> </form>");
            },
                options,
        ...
        modal.prompt = function (message, value, options) {
            return openDialog(
                function (ref) {
                    ...
                    return ("<form class=\"x-form-stacked\"> <div class=\"x-modal-body\"> <label>" + (isString(message) ? message : html(message)) + "</label> <input class=\"x-input\" value=\"" + (value || '') + "\" autofocus> </div> <div class=\"x-modal-footer x-text-right\"> <button class=\"x-button x-button-default x-modal-close\" type=\"button\">" + (labels.cancel) + "</button> <button class=\"x-button x-button-primary\">" + (labels.ok) + "</button> </div> </form>");
            },
                options,
    ...
    var navbar = {
        ...
        data: {
            dropdown: '.x-navbar-nav > li',
            align: !isRtl ? 'left' : 'right',
            clsDrop: 'x-navbar-dropdown',
            mode: undefined,
            offset: undefined,
            delayShow: undefined,
            delayHide: undefined,
            ...
            duration: 200,
            forceHeight: true,
            selMinHeight: '.x-navbar-nav > li > a, .x-navbar-item, .x-navbar-toggle'
        },
        ...
        computed: {
            ...
            dropbar: {
                ...
                get: function(ref) {
                    ...
                    dropbar = this._dropbar || query(dropbar, this.$el) || $('+ .x-navbar-dropbar', this.$el);
                ...
                watch: function(dropbar) {
                    addClass(dropbar, 'x-navbar-dropbar');
                },
...

            {
                ...
                handler: function(_, ref) {
                    ...
                    if (this.dropbarMode === 'slide') {
                        addClass(this.dropbar, 'x-navbar-dropbar-slide');
                    }
    ...
    var offcanvas = {
        ...
        data: {
            ...
            flip: false,
            overlay: false,
            clsPage: 'x-offcanvas-page',
            clsContainer: 'x-offcanvas-container',
            selPanel: '.x-offcanvas-bar',
            clsFlip: 'x-offcanvas-flip',
            clsContainerAnimation: 'x-offcanvas-container-animation',
            clsSidebarAnimation: 'x-offcanvas-bar-animation',
            clsMode: 'x-offcanvas',
            clsOverlay: 'x-offcanvas-overlay',
            selClose: '.x-offcanvas-close',
            container: false
        },
    ...
    var scrollspy = {
        ...
        data: function () { return ({
            ...
            repeat: false,
            delay: 0,
            inViewClass: 'x-scrollspy-inview'
        }); },
...

            {
                ...
                read: function(ref) {
                    ...
                    this.elements.forEach(function (el) {
                        ...
                        if (!el[stateKey]) {
                            el[stateKey] = {cls: data(el, 'x-scrollspy-class') || this$1$1.cls};
                        }
    ...
    var sticky = {
        ...
        data: {
            ...
            clsActive: 'x-active',
            clsInactive: '',
            clsFixed: 'x-sticky-fixed',
            clsBelow: 'x-sticky-below',
            selTarget: '',
            widthElement: false,
            showOnUp: false,
            targetOffset: false
        ...
        connected: function() {
            this.placeholder = $('+ .x-sticky-placeholder', this.$el) || $('<div class="x-sticky-placeholder"></div>');
            this.isFixed = false;
            this.isActive = false;
        },
        ...
        computed: {
            ...
            toggles: {
                ...
                get: function(ref, $el) {
                    ...
                    return $$(toggle, $el).filter(function (el) { return !matches(el, '.x-disabled *, .x-disabled, [disabled]'); });
                },
    ...
    var tab = {
        ...
        connected: function() {
            ...
            var cls = hasClass(this.$el, 'x-tab-left')
                ? 'x-tab-left'
    ...
    // register components
    each(components$1, function (component, name) { return mytags.component(name, component); }
    );
        ...
        methods: {
            ...
            updateNav: function() {
                ...
                this.navItems.forEach(function (el) {
                    ...
                    toggleClass(el, 'x-invisible', this$1$1.finite && (cmd === 'previous' && i === 0 || cmd === 'next' && i >= this$1$1.maxIndex));
                });
    ...
    function install$1(mytags, Lightbox) {
    ...
    var slideshow = {
        ...
        data: {
            ...
            minHeight: false,
            maxHeight: false,
            selList: '.x-slideshow-items',
            attrItem: 'x-slideshow-item',
            selNav: '.x-slideshow-nav',
