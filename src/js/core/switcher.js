...
import {$$, attr, children, css, data, endsWith, findIndex, getIndex, hasClass, matches, queryAll, toggleClass, toNodes, within} from 'utilities';
...
export default {
    ...
    computed: {
        ...
        toggles: {
            ...
            get({toggle}, $el) {
                return $$(toggle, $el).filter(el => !matches(el, '.x-disabled *, .x-disabled, [disabled]'));
            },
